...
function CataloguePageRenovated({ delay }) {
  ...
  return (
    <>
      <Helmet>
        <title>Llanta Renovada - VitaBajío</title>
        <link rel="canonical" href="https://vitabajio.com/" />
        <meta
          name="description"
          content="Descubre nuestro catálogo de llantas renovadas con banda renovada. Somos expertos en la renovación y venta de llantas, ofreciendo productos de calidad que garantizan seguridad y rendimiento en la carretera. ¡Explora nuestra selección y encuentra la llanta perfecta para tu vehículo!"
        />
        <meta
          name="keywords"
          content="Toda posición, Renovado ,Tracción, Eje Libre, Medida, diseño, VitaBajío"
        />
        <meta
          property="og:title"
          content="Llanta Renovada - VitaBajío"
        />
        <meta
