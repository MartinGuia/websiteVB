  ...
  return (
    <>
      <div className="flex justify-center ">
        <div className="flex w-[98%] justify-between shadow-lg h-32 bg-slate-50 drop-shadow-md max-[600px]:h-28 relative z-10 rounded-lg m-4">
          <Link
            to="/"
            className="w-[30%] flex items-center max-[913px]:w-[30%]"
          >
            <img
              src={images.logoVB}
              alt="Logo VitaBajío"
